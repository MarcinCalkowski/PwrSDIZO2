...
Graph::~Graph()
{
	...
	//Ogarn¹æ czy nie trzeba pousuwaæ reszty
}

//zwracanie wartoœci prywatnych
...
void Graph::RandomEdges() { //losowanie krawêdzi
...
void Graph::Show() { //wyœwietlenie grafu macierzowo i listowo
...
void Graph::ShowND() { //wyœwietlenie grafu nieskierowanego macierzowo i listowo
