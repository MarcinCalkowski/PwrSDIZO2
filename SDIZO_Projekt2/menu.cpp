...
int menu::ShowMenu() //Menu g³ówne programu
{
	...
	while (select != '0')
	{
		std::cout << "SDIZO Projekt 2 - Marcin Calkowski nr. 218191\nWybierz opcje:\n\n1. Wczytaj graf z pliku\n2. Wygeneruj losowy graf\n3. Testowanie\n0. Wyjscie\n";
		select = _getch();
				...
				else
				{
					...
					if (a == edgesLoad)
					{
						...
						while (select2 != '0') {
							...
							std::cout << "Wybierz opcje:\n\n------------------------------------\n---  Najkrotsza drogra w grafie  ---\n------------------------------------\n1. Algorytm Dijkstry Lista \n2. Algorytm Dijkstry Macierz\n\n------------------------------------\n--- Minimalne drzewo rozpinajace ---\n------------------------------------\n3. Algorytm Prima Lista\n4. Algorytm Prima Macierz\n\n5. Pokaz graf (skierowany)\n6. Pokaz graf (nieskierowany)\n0. Wyjscie\n";
							select2 = _getch();
							switch (select2)
							{
							case '1':
